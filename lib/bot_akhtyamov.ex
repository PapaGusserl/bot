defmodule Bot.Akhtyamov do
  ...
  def read_command(%{text: "/try", chat: %{id: id}}), do: cmd(:akhtyamov, :sendMessage, %{text: "Try or not try", chat_id: id, reply_markup: %{inline_keyboard: [[%{text: "/hello", callback_data: "/hello"}]]}}) 
